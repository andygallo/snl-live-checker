...
import { SNLData, Episode, Host, MusicalGuest, Schedule } from '../types/snl';
...
export interface SNLState {
  // Data
  snlData: SNLData | null;
  episode: Episode | null;
  host: Host | null;
  musicalGuest: MusicalGuest | null;
...
export interface SNLContextType {
  ...
  setSNLData: (data: SNLData) => void;
  setEpisode: (episode: Episode) => void;
  setHost: (host: Host) => void;
  setMusicalGuest: (guest: MusicalGuest) => void;
...
export const SNLProvider: React.FC<SNLProviderProps> = ({ children }) => {
  ...
  const setMusicalGuest = (guest: MusicalGuest) => {
